            ...
            <div class="card">
                ...
                <div class="card-body px-0">
                    <div class="table-responsive">
                        <table id="petani-list-table" class="table table-striped align-middle mb-0">
                            ...
                            <tbody>
                                @forelse ($petani as $p)
                                    <tr>
                                        <td class="text-center">
                                            @if($p->foto)
                                                <img src="{{ asset('storage/' . $p->foto) }}" 
                                                     alt="profile" 
                                                     class="bg-success-subtle rounded-circle img-fluid avatar-40 shadow-sm">
                                            @else
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('kelola-profil-petani', $p->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-3">
                                            <em>Tidak ada data petani yang tersedia.</em>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
