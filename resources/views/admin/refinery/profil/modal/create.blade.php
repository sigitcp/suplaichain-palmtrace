<div class="modal fade" id="profilRefineryAddModal" tabindex="-1" aria-labelledby="profilRefineryAddModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <div class="modal-header">
        <h5 class="modal-title" id="profilRefineryAddModalLabel">Kelola Profil Refinery</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">
        <form action="{{ route('store-profil-refinery', $user->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-card text-start">
            <div class="row g-3">

              <div class="col-md-6">
                <label class="form-label">Nama Refinery:</label>
                <input type="text" name="nama_refinery" class="form-control" value="{{ $profil->nama_refinery ?? '' }}" required>
              </div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn rounded btn-info">
