                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button class="btn btn-sm btn-success d-flex align-items-center"
                            ...
                            data-bs-target="#profilPksAddModal">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            <div class="card-header">
                                <div class="header-title">
                                    <h4 class="card-title">Informasi PKS</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                @if(!empty($profil))
                                <ul class="list-inline m-0 p-0">
                                    <div class="pb-2">
                                        <h6>Nama PKS:
                                            <strong class="ms-1">{{ $profil->nama_pks ?? '-' }}</strong>
                                        </h6>
                                    </div>
                                    <div class="pb-2">
                                        <h6>Kapasitas TBS (Kg):
                                ...
                                @if($profil->foto_kantor)
                                    ...
                                    <img src="{{ asset('storage/' . $profil->foto_kantor) }}" alt="Foto Kantor" class="img-fluid rounded shadow">

                                    </div>
                                @endif
                                @else
                                <div class="alert alert-warning text-center mb-0">
                                    Belum ada data profil PKS.
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-header">
                                <div class="header-title">
                                    <h4 class="card-title">Titik Koordinat PKS</h4>
                                </div>
                            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    @if(!empty($profil) && $profil->latitude && $profil->longitude)
        ...
        var marker = L.marker([lat, lng]).addTo(map)
            .bindPopup("Lokasi PKS: {{ $profil->nama_pks ?? 'Tidak diketahui' }}")
            .openPopup();
...
@include('admin.pks.profil.modal.create')
@endsection
